...
// Chakra Color Mode
  ...
  const createLinks = (routes) => {
    ...
    return routes
    .filter(prop => prop.name !== "Sign In" && prop.name !== "Réinitialise le mot de passe" && prop.name !== "Chat" && prop.name !== "Discussion" && prop.name !== "Error" && prop.name !== "Vue d'ensemble" && prop.name !== "Analyse avancé" && prop.name !== "Demande collaboration")
