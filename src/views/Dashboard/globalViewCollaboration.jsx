...
export default function GlobalViewCollaboration() {
    const [items, setItems] = useState([
        {
            id: 1,
            label: "Avoir plus d'informations sur l'incident",
            checked: false,
        },
        {
            id: 2,
            label:
                "Proposer un partage d'informations et/ou de ressources sur l'incident",
            checked: false,
        },
        {
            id: 3,
            label: "Proposer une collaboration technique sur l'incident",
            checked: false,
        },
                    ...
                    <Flex direction="column">
                        <Flex align="center" justify="space-between" p="22px">
                            <Text
                                ...
                                fontWeight="bold"
                            >
                                Faire une demande de collaboration sur cet
                                incident
                            </Text>
                        </Flex>
                        <Box minH="100px" p="22px">
                            <Text
                                ...
                                fontWeight="bold"
                            >
                                Déterminer la date de clôture de la
                                collaboration.
                            </Text>
                            <Input
                                type="date"
                        ...
                        <VStack align="start" spacing={4} p="22px">
                            <Text>
                                Quelles sont vos motivations pour la demande de
                                collaboration ?
                            </Text>
                            {items.map((item) => (
                                <Checkbox
